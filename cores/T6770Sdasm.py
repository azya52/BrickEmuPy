class T6770Sdasm():
    ...
    def __init__(self):
        ...
        self._instructions = (
            T6770Sdasm._nop,                          #00 0000 0000 CF -, SF 1; CC16; no operation
            T6770Sdasm._mov_a_m1l,                    #00 0000 0001 A = M[1L]; CF 0, SF 1; CC16
            T6770Sdasm._addc_a_mhl,                   #00 0000 0010 A += M[HL]; CF с, SF !с; CC16
            T6770Sdasm._inc_l,                        #00 0000 0011 L++; CF -, SC !c; CC16
            T6770Sdasm._scan_0,                       #00 0000 0100 SCAN = 0; CF -, SF 1; CC16; Writing to LCD shift register is enabled
            T6770Sdasm._mov_l_b,                      #00 0000 0101 L = B; CF -, SF 1; CC16
            T6770Sdasm._ret_a,                        #00 0000 0110 ?PC = STACKA, L = 0xC; CF -, SF 1; CC32
            T6770Sdasm._tst_t1,                       #00 0000 0111 CF -, SF !t1; CC16; test 1 sec event
            T6770Sdasm._tst_t8,                       #00 0000 1000 CF -, SF !t8; CC16; test 1/8 sec event
            T6770Sdasm._mov_m1l_a,                    #00 0000 1001 M[1L] = A; CF -, SF 1; CC16
            T6770Sdasm._rorc_mhl,                     #00 0000 1010 A = M[HL] = (CF << 3) | (M[HL] >> 1); CF c, SF !c; CC16; Rotate right through CF
            T6770Sdasm._nop,                          #00 0000 1011 CF -, SF 1; CC16; no operation
            T6770Sdasm._incp10,                       #00 0000 1100 inc10(M[HL+1]M[HL]), A = M[HL+1], L++; CF c, SF !c; CC32; Data memory pair (little-endian) increase modulo 10
            T6770Sdasm._in_a_ip,                      #00 0000 1101 A = IP; CF 0, SF 1; CC16; Read input port to A
            T6770Sdasm._rolc_mhl,                     #00 0000 1110 A = M[HL] = (M[HL] << 1) | CF; CF c, SF !c; CC16; Rotate left through CF
            T6770Sdasm._nop,                          #00 0000 1111 CF -, SF 1; CC16; no operation
            T6770Sdasm._mov_h_incb,                   #00 0001 0000 H = B = B + 1; CF -, SF !c; CC16
            T6770Sdasm._mov_a_b,                      #00 0001 0001 A = B; CF 0, SF 1; CC16
            T6770Sdasm._addc_a_b,                     #00 0001 0010 A = A + B + CF; CF c, SF !c; CC16 
            ...
            T6770Sdasm._clearm_mhl_dec,               #00 0001 1010 (L = L - 1, M[HL] = A = 0, B = B - 1)WHILE(B >= 0); CF 0, SF 0; CC16 * (n - 1) + CC32
            T6770Sdasm._nop,                          #00 0001 1011 CF -, SF 1; CC16; no operation
            T6770Sdasm._nop2,                         #00 0001 1100 CF -, SF 1; CC32; no operation
            T6770Sdasm._in_a_iop,                     #00 0001 1101 A = IOP; CF 0, SF 1; CC16; Read input/output port to A
            T6770Sdasm._nop2,                         #00 0001 1110 CF -, SF 1; CC32; no operation
            T6770Sdasm._nop,                          #00 0001 1111 CF -, SF 1; CC16; no operation
            T6770Sdasm._mov_h_b_a,                    #00 0010 0000 H = B = A; CF -, SF 1; CC16
            T6770Sdasm._mov_a_mhl,                    #00 0010 0001 A = M[HL]; CF 0, SF 1; CC16
            T6770Sdasm._subc_a_mhl,                   #00 0010 0010 A = M[HL] - A - CF; CF b, SF !b; CC16
            T6770Sdasm._dec_l,                        #00 0010 0011 L = L - 1; CF -, SF !b; CC16
            T6770Sdasm._scan_1,                       #00 0010 0100 SCAN = 1; CF -, SF 1; CC16; Writing to LCD shift register is inhibited
            T6770Sdasm._mov_l_a,                      #00 0010 0101 L = A; CF -, SF 1; CC16
            T6770Sdasm._ret_d,                        #00 0010 0110 ?PC = STACKD, L = 0xF; CF -, SF 1; CC32
            T6770Sdasm._0027,                         #00 0010 0111 ?IOP direction; CF -, SF 1; CC16
            T6770Sdasm._tst_t64,                      #00 0010 1000 CF -, SF !t64; CC16; test 1/64 sec event
            T6770Sdasm._mov_mhl_a,                    #00 0010 1001 M[HL] = A; CF -, SF 1; CC16
            T6770Sdasm._exe_cf_a,                     #00 0010 1010 ?exe(PC + 1), exe(CF:A); CF -, SF 1; CC32; Execute the following instruction and then CF:A
            T6770Sdasm._nop,                          #00 0010 1011 CF -, SF 1; CC16; no operation
            T6770Sdasm._decp10,                       #00 0010 1100 dec10(M[HL+1]M[HL]), A = M[HL+1], L++; CF b, SF !b; CC32; Data memory pair (little-endian) decrease modulo 10
            T6770Sdasm._inc_mhl,                      #00 0010 1101 A = M[HL] = M[HL] + 1; CF c, SF !c; CC16
            T6770Sdasm._nop2,                         #00 0010 1110 CF -, SF 1; CC32; no operation
            T6770Sdasm._nop,                          #00 0010 1111 CF -, SF 1; CC16; no operation
            T6770Sdasm._mov_h_dec_b,                  #00 0011 0000 H = B = B - 1; CF -, SF !c; CC16
            T6770Sdasm._mov_a_l,                      #00 0011 0001 A = L; CF 0, SF 1; CC16
            T6770Sdasm._subc_a_b,                     #00 0011 0010 A = B - A - CF; CF = b, SF = !b; CC16
            ...
            T6770Sdasm._clearm_mhl_inc,               #00 0011 1010 (L = L + 1, M[HL] = A = 0, B = B - 1)WHILE(B >= 0); CF 0, SF 1; CC16 * (n - 1) + CC32
            T6770Sdasm._nop,                          #00 0011 1011 CF -, SF 1; CC16; no operation
            T6770Sdasm._nop2,                         #00 0011 1100 CF -, SF 1; CC32; no operation
            T6770Sdasm._dec_mhl,                      #00 0011 1101 A = M[HL] = M[HL] - 1; CF b, SF !b; CC16
            T6770Sdasm._nop2,                         #00 0011 1110 CF -, SF 1; CC32; no operation
            T6770Sdasm._nop,                          #00 0011 1111 CF -, SF 1; CC16; no operation
            *([T6770Sdasm._mov_mh4linc_imm] * 16),    #00 0100 iiii M[HL] = IMM, H = B = 4, L = L + 1; CF -, SF !c; CC16
            *([T6770Sdasm._mov_mh4ldec_imm] * 16),    #00 0101 iiii M[HL] = IMM, H = B = 4, L = L - 1; CF -, SF !b; CC16
            *([T6770Sdasm._mov_mhlinc_imm] * 16),     #00 0110 iiii M[HL] = IMM, L = L + 1; CF -, SF !c; CC16
            *([T6770Sdasm._mov_mhl_imm] * 16),        #00 0111 iiii M[HL] = IMM, H = B = B + 1, A = 0; CF 0, SF !c; CC16
            *([T6770Sdasm._movm_mhlsubi_mhl] * 16),   #00 1000 iiii (M[H:L-IMM] = M[HL], L = L + 1, B = B + 1)WHILE(B <= 15), B = IMM - 1; CF 0, SF (IMM != 0); CC24 * (n - 1) + CC32
            *([T6770Sdasm._movm_mhladdi_mhl] * 16),   #00 1001 iiii (M[H:L+IMM] = M[HL], L = L - 1, B = B + 1)WHILE(B <= 15), B = IMM - 1; CF 0, SF (IMM != 0); CC24 * (n - 1) + CC32
            *([T6770Sdasm._inc_m1i] * 16),            #00 1010 iiii A = M[1:IMM] = M[1:IMM] + 1; CF c, SF !c; CC16
            *([T6770Sdasm._dec_m1i] * 16),            #00 1011 iiii A = M[1:IMM] = M[1:IMM] - 1; CF b, SF !b; CC16
            *([T6770Sdasm._addc10m_mhl_mbl] * 16),    #00 1100 iiii (A = M[HL] = (M[HL] + M[BL] + CF) mod 10, L = L + 1)WHILE(L < 16 - IMM); CF c, SF 1; CC20 * (n - 1) + CC32
            *([T6770Sdasm._subc10m_mhl_mbl] * 16),    #00 1101 iiii (A = M[HL] = (M[HL] - M[BL] - CF) mod 10, L = L + 1)WHILE(L < 16 - IMM); CF b, SF 1; CC20 * (n - 1) + CC32
            *([T6770Sdasm._out_outp_imm] * 16),       #00 1110 iiii A = OUTP = IMM; CF 0, SF 1; CC16
            *([T6770Sdasm._out_iop_imm] * 16),        #00 1111 iiii A = IOP = IMM; CF 0, SF 1; CC16
            *([T6770Sdasm._sbit_m] * 64),             #01 00bb hiii A = M[(HL if h)/0:IMM].b = 1; CF 0, SF 1; CC16
            *([T6770Sdasm._rbit_m] * 64),             #01 01bb hiii A = M[(HL if h)/0:IMM].b = 0; CF 0, SF 1; CC16
            *([T6770Sdasm._tbit_m] * 64),             #01 10bb hiii test M[(HL if h)/0:IMM].b; CF -, SF b==0; CC16
            *([T6770Sdasm._outm_lcd_mhl] * 16),       #01 1100 iiii (LCDP = M[HL], L = L - 1)WHILE((L + 1) >= IMM); CF -, SF 1, CC16 * (n - 1) + CC32
            *([T6770Sdasm._mov_pch_imm] * 16),        #01 1101 iiii PC<11:8> = IMM; CF -, SF -?; CC16
            *([T6770Sdasm._cmp_mhl_imm] * 16),        #01 1110 iiii A = M[HL] - IMM; CF b, SF z; CC32
            *([T6770Sdasm._addc_a_imm] * 16),         #01 1111 iiii addc A, IMM; CF c, SF !c; CC16
            *([T6770Sdasm._mov_l_imm] * 16),          #10 0000 iiii L = IMM; CF -, SF 1; CC16
            *([T6770Sdasm._calla] * 16),              #10 0001 iiii ?STACKA = PC, PC = hh:0b011111:IMM, L = 0; CF -, SF 1; CC32
            *([T6770Sdasm._mov_a_m0i] * 16),          #10 0010 iiii A = M[0:IMM]; CF 0, SF 1; CC16
            *([T6770Sdasm._calld] * 16),              #10 0011 iiii ?STACKD = PC, PC = hh:0b111111:IMM, L = 0; CF -, SF 1; CC32
            *([T6770Sdasm._mov_b_imm] * 16),          #10 0100 iiii B = IMM; CF -, SF 1; CC16
            *([T6770Sdasm._calla] * 16),              #10 0101 iiii ?STACKA = PC, PC = hh:0b011111:IMM, L = 0; CF -, SF 1; CC32
            *([T6770Sdasm._mov_m0i_a] * 16),          #10 0110 iiii M[0:IMM] = A; CF -, SF 1; CC16
            *([T6770Sdasm._calld] * 16),              #10 0111 iiii ?STACKD = PC, PC = hh:0b111111:IMM, L = 0; CF -, SF 1; CC32
            *([T6770Sdasm._mov_h_imm] * 16),          #10 1000 iiii H = IMM; CF -, SF 1; CC16
            *([T6770Sdasm._calla] * 16),              #10 1001 iiii ?STACKA = PC, PC = hh:0b011111:IMM, L = 0; CF -, SF 1; CC32
            *([T6770Sdasm._mov_a_m1i] * 16),          #10 1010 iiii A = M[1:IMM]; CF 0, SF 1; CC16
            *([T6770Sdasm._calld] * 16),              #10 1011 iiii ?STACKD = PC, PC = hh:0b111111:IMM, L = 0; CF -, SF 1; CC32
            *([T6770Sdasm._mov_a_imm] * 16),          #10 1100 iiii A = IMM; CF 0, SF 1; CC16
            *([T6770Sdasm._calla] * 16),              #10 1101 iiii ?STACKA = PC, PC = hh:0b011111:IMM, L = 0; CF -, SF 1; CC32
            *([T6770Sdasm._mov_m1i_a] * 16),          #10 1110 iiii M[1:IMM] = A; CF -, SF 1; CC16
            *([T6770Sdasm._calld] * 16),              #10 1111 iiii ?STACKD = PC, PC = hh:0b111111:IMM, L = 0; CF -, SF 1; CC32
            *([T6770Sdasm._bs_imm] * 256)             #11 iiii iiii if SF (PC<7:0> = IMM); CF -, SF 1; CC16
        )
    ...
    def _ret_a(self, pc, opcode):
        #00 0000 0110 ?PC = STACKA, L = 0xC; CF -, SF 1; CC32
        return ("reta", "?PC = STACKA, L = 0xC; CF -, SF 1")
    ...
    def _delay_b(self, pc, opcode):
        ...
        return ("delay B (B-- > 0)", "B = 0xF; CF -, SF 0; Delay (B * CC8 + CC16)")
    ...
    def _ret_d(self, pc, opcode):
        #00 0010 0110 ?PC = STACKD, L = 0xF; CF -, SF 1; CC32
        return ("retd", "?PC = STACKD, L = 0xF; CF -, SF 1")
    ...
    def _tst_t64(self, pc, opcode):
        ...
        return ("tst T64", "CF -, SF !t1; CC16; test 1/64 sec event")
    ...
    def _addc_a_imm(self, pc, opcode):
        #01 1111 iiii addc A, IMM; CF c, SF !c; CC16
    ...
    def _calla(self, pc, opcode):
        ...
        return ("calla %0.3X" % (((opcode & 0xF0) << 4) | 0xF0 | (opcode & 0xF)), "?STACKA = PC, PC = hh:0b011111:IMM, L = 0xC; CF -, SF 1")
    ...
    def _calld(self, pc, opcode):
        ...
        return ("calld %0.3X" % (((opcode & 0xF0) << 4) | 0xF0 | (opcode & 0xF)), "?STACKD = PC, PC = hh:0b111111:IMM, L = 0xF; CF -, SF 1")
