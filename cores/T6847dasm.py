class T6847dasm():
    ...
    def __init__(self, roots=None):
        ...
        self._instructions = (
            T6847dasm._nop,                          #00 0000 0000 CF -, SF 1; CC16; no operation
            T6847dasm._mov_l_b,                      #00 0000 0001 L = B; CF -, SF 1; CC16
            T6847dasm._addc_a_mhl,                   #00 0000 0010 A += M[HL]; CF с, SF !с; CC16
            T6847dasm._inc_l,                        #00 0000 0011 L++; CF -, SC !c; CC16
            T6847dasm._scan_0,                       #00 0000 0100 SCAN = 0; CF -, SF 1; CC16; Writing to LCD shift register is enabled
            T6847dasm._nop,                          #00 0000 0101 CF -, SF 1; CC16; no operation
            T6847dasm._ret0,                         #00 0000 0110 ?PC = STACK0, L = 0xC; CF -, SF 1; CC32
            T6847dasm._tst_px,                       #00 0000 0111 CF -, SF !PXF; CC16; Test Prescaler Event Flag X (prescaler bit hardwired via mask option)
            T6847dasm._tst_py,                       #00 0000 1000 CF -, SF !PYF; CC16; Test Prescaler Event Flag Y (prescaler bit hardwired via mask option)
            T6847dasm._mov_m1l_a,                    #00 0000 1001 M[1L] = A; CF -, SF 1; CC16
            T6847dasm._rorc_mhl,                     #00 0000 1010 A = M[HL] = (CF << 3) | (M[HL] >> 1); CF c, SF !c; CC16; Rotate right through CF
            T6847dasm._mov_a_m1l,                    #00 0000 1011 A = M[1L]; CF -, SF 1; CC16
            T6847dasm._incp10,                       #00 0000 1100 inc10(M[HL+1]M[HL]), A = M[HL+1], L++; CF c, SF !c; CC32; Data memory pair (little-endian) increase modulo 10
            T6847dasm._in_a_ip,                      #00 0000 1101 A = IP; CF 0, SF 1; CC16; Read input port to A
            T6847dasm._rolc_mhl,                     #00 0000 1110 A = M[HL] = (M[HL] << 1) | CF; CF c, SF !c; CC16; Rotate left through CF
            T6847dasm._mov_a_mhl,                    #00 0000 1111 A = M[HL]; CF -, SF 1; CC16
            T6847dasm._mov_h_incb,                   #00 0001 0000 H = B = B + 1; CF -, SF !c; CC16
            T6847dasm._mov_a_b,                      #00 0001 0001 A = B; CF 0, SF 1; CC16
            T6847dasm._addc_a_b,                     #00 0001 0010 A = A + B + CF; CF c, SF !c; CC16 
            T6847dasm._inc_b,                        #00 0001 0011 B = B + 1; CF -, SF !c; CC16
            T6847dasm._nop,                          #00 0001 0100 CF -, SF 1; CC16; no operation
            T6847dasm._osc_ext,                      #00 0001 0101 ?clock from external oscillator (32k)
            T6847dasm._nop2,                         #00 0001 0110 CF -, SF 1; CC32; no operation
            T6847dasm._nop,                          #00 0001 0111 CF -, SF 1; CC16; no operation
            T6847dasm._wait_frame,                   #00 0001 1000 ?wait next frame
            T6847dasm._mov_b_a,                      #00 0001 1001 B = A; CF -, SF 1; CC16
            T6847dasm._clearm_mhl_dec,               #00 0001 1010 (L = L - 1, M[HL] = A = 0, B = B - 1)WHILE(B >= 0); CF 0, SF 0; CC16 * (n - 1) + CC32
            T6847dasm._out_bz_1,                     #00 0001 1011 BZ = 1; CF -, SF 1; CC32; Set buzzer pin (0V)
            T6847dasm._nop2,                         #00 0001 1100 CF -, SF 1; CC32; no operation
            T6847dasm._in_a_iop,                     #00 0001 1101 A = IOP; CF 0, SF 1; CC16; Read input/output port to A
            T6847dasm._nop2,                         #00 0001 1110 CF -, SF 1; CC32; no operation
            T6847dasm._nop,                          #00 0001 1111 CF -, SF 1; CC16; no operation
            T6847dasm._mov_h_a,                      #00 0010 0000 H = A; CF -, SF 1; CC16
            T6847dasm._mov_l_a,                      #00 0010 0001 L = A; CF -, SF 1; CC16
            T6847dasm._subc_a_mhl,                   #00 0010 0010 A = M[HL] - A - CF; CF b, SF !b; CC16
            T6847dasm._dec_l,                        #00 0010 0011 L = L - 1; CF -, SF !b; CC16
            T6847dasm._scan_1,                       #00 0010 0100 SCAN = 1; CF -, SF 1; CC16; Writing to LCD shift register is inhibited
            T6847dasm._nop,                          #00 0010 0101 CF -, SF 1; CC16; no operation
            T6847dasm._ret1,                         #00 0010 0110 ?PC = STACK1, L = 0xF; CF -, SF 1; CC32
            T6847dasm._0027,                         #00 0010 0111 ?IOP direction; CF -, SF 1; CC16
            T6847dasm._tst_pz,                       #00 0010 1000 CF -, SF !PZF; CC16; Test Prescaler Event Flag Z (prescaler bit hardwired via mask option)
            T6847dasm._mov_mhl_a,                    #00 0010 1001 M[HL] = A; CF -, SF 1; CC16
            T6847dasm._exe_cf_a,                     #00 0010 1010 ?exe(PC + 1), exe(CF:A); CF -, SF 1; CC32; Execute the following instruction and then CF:A
            T6847dasm._nop,                          #00 0010 1011 CF -, SF 1; CC16; no operation
            T6847dasm._decp10,                       #00 0010 1100 dec10(M[HL+1]M[HL]), A = M[HL+1], L++; CF b, SF !b; CC32; Data memory pair (little-endian) decrease modulo 10
            T6847dasm._inc_mhl,                      #00 0010 1101 A = M[HL] = M[HL] + 1; CF c, SF !c; CC16
            T6847dasm._nop2,                         #00 0010 1110 CF -, SF 1; CC32; no operation
            T6847dasm._nop,                          #00 0010 1111 CF -, SF 1; CC16; no operation
            T6847dasm._mov_h_dec_b,                  #00 0011 0000 H = B = B - 1; CF -, SF !c; CC16
            T6847dasm._mov_a_l,                      #00 0011 0001 A = L; CF 0, SF 1; CC16
            T6847dasm._subc_a_b,                     #00 0011 0010 A = B - A - CF; CF = b, SF = !b; CC16
            T6847dasm._dec_b,                        #00 0011 0011 B = B - 1; CF -, SF !b; CC16 
            T6847dasm._nop,                          #00 0011 0100 CF -, SF 1; CC16; no operation
            T6847dasm._osc_int,                      #00 0011 0101 ?clock from interlal oscillation (resistor)
            T6847dasm._nop2,                         #00 0011 0110 CF -, SF 1; CC32; no operation
            T6847dasm._0037,                         #00 0011 0111 ?IOP direction; CF -, SF 1; CC16
            T6847dasm._wait_com,                     #00 0011 1000 ?wait next com
            T6847dasm._mov_b_l,                      #00 0011 1001 B = L; CF -, SF 1; CC16
            T6847dasm._clearm_mhl_inc,               #00 0011 1010 (L = L + 1, M[HL] = A = 0, B = B - 1)WHILE(B >= 0); CF 0, SF 1; CC16 * (n - 1) + CC32
            T6847dasm._out_bz_0,                     #00 0011 1011 BZ = 0; CF -, SF 1; CC32; Reset buzzer pin (+3V)
            T6847dasm._nop2,                         #00 0011 1100 CF -, SF 1; CC32; no operation
            T6847dasm._dec_mhl,                      #00 0011 1101 A = M[HL] = M[HL] - 1; CF b, SF !b; CC16
            T6847dasm._nop2,                         #00 0011 1110 CF -, SF 1; CC32; no operation
            T6847dasm._nop,                          #00 0011 1111 CF -, SF 1; CC16; no operation
            *([T6847dasm._addc_a_imm] * 16),         #00 0100 iiii A = A + IMM + CF; CF c, SF !c; CC16 
            *([T6847dasm._subc_a_imm] * 16),         #00 0101 iiii A = IMM - A - CF; CF = b, SF = !b; CC16
            *([T6847dasm._mov_mhlinc_imm] * 16),     #00 0110 iiii M[HL] = IMM, L = L + 1; CF -, SF !c; CC16
            *([T6847dasm._mov_mhl_imm] * 16),        #00 0111 iiii M[HL] = IMM, H = B = B + 1; CF -, SF !c; CC16
            *([T6847dasm._movm_mhlsubi_mhl] * 16),   #00 1000 iiii (M[H:L-IMM] = M[HL], L = L + 1, B = B + 1)WHILE(B <= 15), B = IMM - 1; CF 0, SF (IMM != 0); CC24 * (n - 1) + CC32
            *([T6847dasm._movm_mhladdi_mhl] * 16),   #00 1001 iiii (M[H:L+IMM] = M[HL], L = L - 1, B = B + 1)WHILE(B <= 15), B = IMM - 1; CF 0, SF (IMM != 0); CC24 * (n - 1) + CC32
            *([T6847dasm._inc_m1i] * 16),            #00 1010 iiii A = M[1:IMM] = M[1:IMM] + 1; CF c, SF !c; CC16
            *([T6847dasm._dec_m1i] * 16),            #00 1011 iiii A = M[1:IMM] = M[1:IMM] - 1; CF b, SF !b; CC16
            *([T6847dasm._addc10m_mhl_mbl] * 16),    #00 1100 iiii (A = M[HL] = (M[HL] + M[BL] + CF) mod 10, L = L + 1)WHILE(L < 16 - IMM); CF c, SF 1; CC20 * (n - 1) + CC32
            *([T6847dasm._subc10m_mhl_mbl] * 16),    #00 1101 iiii (A = M[HL] = (M[HL] - M[BL] - CF) mod 10, L = L + 1)WHILE(L < 16 - IMM); CF b, SF 1; CC20 * (n - 1) + CC32
            *([T6847dasm._out_outp_imm] * 16),       #00 1110 iiii A = OUTP = IMM; CF 0, SF 1; CC16
            *([T6847dasm._out_iop_imm] * 16),        #00 1111 iiii A = IOP = IMM; CF 0, SF 1; CC16
            *([T6847dasm._sbit_m] * 64),             #01 00bb hiii if (h) (if (b == 1) A = M[HL] = M[HL] | B else A = M[HL]) else (A = M[0:IMM].b = 1); CF 0, SF 1; CC16
            *([T6847dasm._rbit_m] * 64),             #01 01bb hiii if (h) (if (b == 1) A = M[HL] = M[HL] & ~B else A = M[HL]) else (A = M[0:IMM].b = 0); CF 0, SF 1; CC16
            *([T6847dasm._tbit_m] * 64),             #01 10bb hiii if (h and b == 1) (M[HL] > (M[HL] | B)) else (M[(HL if h)/0:IMM].b == 0); CF -, SF res; CC16
            *([T6847dasm._outm_lcd_mhl] * 16),       #01 1100 iiii (LCDP = M[HL], L = L - 1)WHILE((L + 1) >= IMM), H = A = A + 1, L = 0xF; CF A==0, SF !(A==0), CC16 * (n - 1) + CC32
            *([T6847dasm._mov_pch_imm] * 16),        #01 1101 iiii PC<11:8> = IMM; CF -, SF -?; CC16
            *([T6847dasm._cmp_mhl_imm] * 16),        #01 1110 iiii A = M[HL] - IMM; CF b, SF z; CC32
            *([T6847dasm._delay_nl_imm] * 16),       #01 1111 iiii L = IMM; CF -, SF 0; CC4 * (15 - L) + CC16
            *([T6847dasm._mov_l_imm] * 16),          #10 0000 iiii L = IMM; CF -, SF 1; CC16
            *([T6847dasm._call0] * 16),              #10 0001 iiii ?STACK0 = PC, PC = hh:0b011111:IMM, L = 0; CF -, SF 1; CC32
            *([T6847dasm._mov_a_m0i] * 16),          #10 0010 iiii A = M[0:IMM]; CF 0, SF 1; CC16
            *([T6847dasm._call1] * 16),              #10 0011 iiii ?STACK1 = PC, PC = hh:0b111111:IMM, L = 0; CF -, SF 1; CC32
            *([T6847dasm._mov_b_imm] * 16),          #10 0100 iiii B = IMM; CF -, SF 1; CC16
            *([T6847dasm._call0] * 16),              #10 0101 iiii ?STACK0 = PC, PC = hh:0b011111:IMM, L = 0; CF -, SF 1; CC32
            *([T6847dasm._mov_m0i_a] * 16),          #10 0110 iiii M[0:IMM] = A; CF -, SF 1; CC16
            *([T6847dasm._call1] * 16),              #10 0111 iiii ?STACK1 = PC, PC = hh:0b111111:IMM, L = 0; CF -, SF 1; CC32
            *([T6847dasm._mov_h_imm] * 16),          #10 1000 iiii H = IMM; CF -, SF 1; CC16
            *([T6847dasm._call0] * 16),              #10 1001 iiii ?STACK0 = PC, PC = hh:0b011111:IMM, L = 0; CF -, SF 1; CC32
            *([T6847dasm._mov_a_m1i] * 16),          #10 1010 iiii A = M[1:IMM]; CF 0, SF 1; CC16
            *([T6847dasm._call1] * 16),              #10 1011 iiii ?STACK1 = PC, PC = hh:0b111111:IMM, L = 0; CF -, SF 1; CC32
            *([T6847dasm._mov_a_imm] * 16),          #10 1100 iiii A = IMM; CF 0, SF 1; CC16
            *([T6847dasm._call0] * 16),              #10 1101 iiii ?STACK0 = PC, PC = hh:0b011111:IMM, L = 0; CF -, SF 1; CC32
            *([T6847dasm._mov_m1i_a] * 16),          #10 1110 iiii M[1:IMM] = A; CF -, SF 1; CC16
            *([T6847dasm._call1] * 16),              #10 1111 iiii ?STACK1 = PC, PC = hh:0b111111:IMM, L = 0; CF -, SF 1; CC32
            *([T6847dasm._bs_imm] * 256)             #11 iiii iiii if SF (PC<7:0> = IMM); CF -, SF 1; CC16
        )
    ...
    def _disassemble(self, pc, rom, comments):
        ...
        while ((pc * 2) < rom.size()):
            ...
            instr = self._instructions[opcode & 0x3FF](self, pc, opcode)
    ...
    def _call0(self, pc, opcode):
        ...
        return ("call0 %0.4X" % (((opcode & 0x400) << 2) | ((opcode & 0xF0) << 4) | 0xF0 | (opcode & 0xF)), "?STACK0 = PC, PC = hh:0b011111:IMM, L = 0xC; CF -, SF 1")
    ...
    def _call1(self, pc, opcode):
        ...
        return ("call1 %0.4X" % (((opcode & 0x400) << 2) | ((opcode & 0xF0) << 4) | 0xF0 | (opcode & 0xF)), "?STACK1 = PC, PC = hh:0b111111:IMM, L = 0xF; CF -, SF 1")
    ...
    def _bs_imm(self, pc, opcode):
        ...
        if ((self._prev_opcode & 0x3F0) == 0b0111010000):
            return ("bs %0.4X" % ((pc & 0x1000) | ((self._prev_opcode & 0xF) << 8) | (opcode & 0x0FF)), "if SF (PC<7:0> = IMM); CF -, SF 1")
        return ("bs %0.4X" % ((pc & 0x1F00) | (opcode & 0x0FF)), "if SF (PC<7:0> = IMM); CF -, SF 1")