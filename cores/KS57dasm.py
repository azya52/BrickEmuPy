class KS57dasm():
    ...
    def __init__(self, roots=None):
        ...
        self._instruction_tbl = (
            *([KS57dasm._jr_mraddr] * 16),           #0000AAAA
            *([KS57dasm._jr_raddr] * 16),            #0001AAAA
            *([KS57dasm._ref] * 8),                  #00100XXX
            KS57dasm._pop_ea,                        #00101000
            KS57dasm._push_ea,                       #00101001
            KS57dasm._pop_hl,                        #00101010
            KS57dasm._push_hl,                       #00101011
            KS57dasm._pop_wx,                        #00101100
            KS57dasm._push_wx,                       #00101101
            KS57dasm._pop_yz,                        #00101110
            KS57dasm._push_yz,                       #00101111
            *([KS57dasm._ref] * 8),                  #00110XXX
            KS57dasm._cpse_a_ahl,                    #00111000 
            KS57dasm._and_a_ahl,                     #00111001
            KS57dasm._or_a_ahl,                      #00111010
            KS57dasm._xor_a_ahl,                     #00111011
            KS57dasm._sbc_a_ahl,                     #00111100
            KS57dasm._sbs_a_ahl,                     #00111101
            KS57dasm._adc_a_ahl,                     #00111110
            KS57dasm._ads_a_ahl,                     #00111111
            *([KS57dasm._ref] * 8),                  #01000XXX
            *([KS57dasm._decs_r] * 8),               #01001RRR
            *([KS57dasm._ref] * 8),                  #01010XXX
            *([KS57dasm._incs_r] * 8),               #01011RRR
            *([KS57dasm._ref] * 8),                  #01100XXX
            *([KS57dasm._xch_a_ra] * 8),             #01101RRR
            *([KS57dasm._ref] * 8),                  #01110XXX
            KS57dasm._dummy,                         #01111000
            KS57dasm._xch_a_da,                      #01111001 AAAAAAAA
            KS57dasm._xchi_a_ahl,                    #01111010
            KS57dasm._xchd_a_ahl,                    #01111011
            KS57dasm._dummy,                         #01111100
            KS57dasm._xch_a_ahl,                     #01111101
            KS57dasm._xch_a_awx,                     #01111110
            KS57dasm._xch_a_awl,                     #01111111
            KS57dasm._dummy,                         #10000000
            KS57dasm._ld_ea_imm,                     #10000001 DDDDDDDD
            KS57dasm._incs_hl,                       #10000010
            KS57dasm._ld_hl_imm,                     #10000011 DDDDDDDD
            KS57dasm._incs_wx,                       #10000100
            KS57dasm._ld_wx_imm,                     #10000101 DDDDDDDD
            KS57dasm._incs_yz,                       #10000110
            KS57dasm._ld_yz_imm,                     #10000111 DDDDDDDD
            KS57dasm._rrc_a,                         #10001000
            KS57dasm._ld_da_a,                       #10001001 AAAAAAAA
            KS57dasm._ldi_a_ahl,                     #10001010
            KS57dasm._ldd_a_ahl,                     #10001011
            KS57dasm._ld_a_da,                       #10001100 AAAAAAAA
            KS57dasm._ld_a_ahl,                      #10001101
            KS57dasm._ld_a_awx,                      #10001110
            KS57dasm._ld_a_awl,                      #10001111
            *([KS57dasm._jps_addr12] * 16),          #1001AAAA AAAAAAAA
            *([KS57dasm._ads_a_im] * 16),            #1010DDDD
            *([KS57dasm._ld_a_im] * 16),             #1011DDDD
            KS57dasm._bitr_da_bit,                   #11000000 AAAAAAAA
            KS57dasm._bits_da_bit,                   #11000001 AAAAAAAA
            KS57dasm._btsf_da_bit,                   #11000010 AAAAAAAA
            KS57dasm._btst_da_bit,                   #11000011 AAAAAAAA
            KS57dasm._ld_ahl_a,                      #11000100
            KS57dasm._ret,                           #11000101
            KS57dasm._dummy,                         #11000110
            KS57dasm._dummy,                         #11000111
            KS57dasm._ldc_ea_aea,                    #11001000
            KS57dasm._ads_ea_imm,                    #11001001 DDDDDDDD
            KS57dasm._incs_da,                       #11001010 AAAAAAAA
            KS57dasm._dummy,                         #11001011
            KS57dasm._ldc_ea_awx,                    #11001100
            KS57dasm._ld_da_ea,                      #11001101 AAAAAAAA
            KS57dasm._ld_ea_da,                      #11001110 AAAAAAAA
            KS57dasm._xch_ea_da,                     #11001111 AAAAAAAA
            KS57dasm._bitr_da_bit,                   #11010000 AAAAAAAA
            KS57dasm._bits_da_bit,                   #11010001 AAAAAAAA
            KS57dasm._btsf_da_bit,                   #11010010 AAAAAAAA
            KS57dasm._btst_da_bit,                   #11010011 AAAAAAAA
            KS57dasm._dummy,                         #11010100
            KS57dasm._iret,                          #11010101
            KS57dasm._ccf,                           #11010110
            KS57dasm._btst_cy,                       #11010111
            KS57dasm._dummy,                         #11011000
            KS57dasm._instruction_11011001,          #11011001
            KS57dasm._dummy,                         #11011010
            KS57dasm._instruction_11011011,          #11011011
            KS57dasm._instruction_11011100,          #11011100
            KS57dasm._instruction_11011101,          #11011101
            KS57dasm._dummy,                         #11011110
            KS57dasm._dummy,                         #11011111
            KS57dasm._bitr_da_bit,                   #11100000 AAAAAAAA
            KS57dasm._bits_da_bit,                   #11100001 AAAAAAAA
            KS57dasm._btsf_da_bit,                   #11100010 AAAAAAAA
            KS57dasm._btst_da_bit,                   #11100011 AAAAAAAA
            KS57dasm._dummy,                         #11100100
            KS57dasm._sret,                          #11100101
            KS57dasm._bitr_cy,                       #11100110
            KS57dasm._bits_cy,                       #11100111
            *([KS57dasm._calls_addr11] * 8),         #11101AAA AAAAAAAA
            KS57dasm._bitr_da_bit,                   #11110000 AAAAAAAA
            KS57dasm._bits_da_bit,                   #11110001 AAAAAAAA
            KS57dasm._btsf_da_bit,                   #11110010 AAAAAAAA
            KS57dasm._btst_da_bit,                   #11110011 AAAAAAAA
            KS57dasm._instruction_11110100,          #11110100
            KS57dasm._instruction_11110101,          #11110101
            KS57dasm._instruction_11110110,          #11110110
            KS57dasm._instruction_11110111,          #11110111
            KS57dasm._instruction_11111000,          #11111000
            KS57dasm._instruction_11111001,          #11111001
            KS57dasm._dummy,                         #11111010
            KS57dasm._dummy,                         #11111011
            KS57dasm._instruction_11111100,          #11111100
            KS57dasm._instruction_11111101,          #11111101
            KS57dasm._instruction_11111110,          #11111110
            KS57dasm._instruction_11111111,          #11111111
        )

        self._instruction_11011001_tbl = (
            KS57dasm._cpse_r_im,                     #11011001 DDDD0RRR
            KS57dasm._ld_ra_im                       #11011001 DDDD1RRR
        )

        self._instruction_11011011_tbl = (
            KS57dasm._jp_addr14,                     #11011011 00AAAAAA AAAAAAAA
            KS57dasm._call_addr14                    #11011011 01AAAAAA AAAAAAAA
        )
        
        self._instruction_11011100_tbl = (
            KS57dasm._ld_ahl_ea,                     #11011100 00000000
            KS57dasm._xch_ea_ahl,                    #11011100 00000001
            *([KS57dasm._dummy] * 6),
            KS57dasm._ld_ea_ahl,                     #11011100 00001000
            KS57dasm._cpse_ea_ahl,                   #11011100 00001001
            *([KS57dasm._dummy] * 6),
            *([KS57dasm._and_rrb_ea] * 8),           #11011100 00010RR0
            *([KS57dasm._and_ea_rr] * 8),            #11011100 00011RR0
            *([KS57dasm._or_rrb_ea] * 8),            #11011100 00100RR0
            *([KS57dasm._or_ea_rr] * 8),             #11011100 00101RR0
            *([KS57dasm._xor_rrb_ea] * 8),           #11011100 00110RR0
            *([KS57dasm._xor_ea_rr] * 8),            #11011100 00111RR0
            *([KS57dasm._dummy] * 64),               #11011100 01XXXXXX
            *([KS57dasm._dummy] * 16),               #11011100 1000XXXX
            *([KS57dasm._ads_rrb_ea] * 8),           #11011100 10010RR0
            *([KS57dasm._ads_ea_rr] * 8),            #11011100 10011RR0
            *([KS57dasm._adc_rrb_ea] * 8),           #11011100 10100RR0
            *([KS57dasm._adc_ea_rr] * 8),            #11011100 10101RR0
            *([KS57dasm._sbs_rrb_ea] * 8),           #11011100 10110RR0
            *([KS57dasm._sbs_ea_rr] * 8),            #11011100 10111RR0
            *([KS57dasm._sbc_rrb_ea] * 8),           #11011100 11000RR0
            *([KS57dasm._sbc_ea_rr] * 8),            #11011100 11001RR0
            *([KS57dasm._dummy] * 8),                #11011100 11010XXX
            *([KS57dasm._decs_rr] * 8),              #11011100 11011RR0
            *([KS57dasm._xch_ea_rrb] * 8),           #11011100 11100RR0
            *([KS57dasm._cpse_ea_rr] * 8),           #11011100 11101RR0
            *([KS57dasm._ld_rrb_ea] * 8),            #11011100 11110RR0
            *([KS57dasm._ld_ea_rrb] * 8),            #11011100 11111RR0
        )
        
        self._instruction_11011101_tbl = (
            *([KS57dasm._ld_ra_a] * 8),              #11011101 00000RRR
            *([KS57dasm._ld_a_r] * 8),               #11011101 00001RRR
            *([KS57dasm._and_a_im] * 16),            #11011101 0001DDDD
            *([KS57dasm._or_a_im] * 16),             #11011101 0010DDDD
            *([KS57dasm._xor_a_im] * 16),            #11011101 0011DDDD
            *([KS57dasm._smb_n] * 16),               #11011101 0100NNNN
            *([KS57dasm._srb_n] * 4),                #11011101 010100NN
            *([KS57dasm._dummy] * 4),                #11011101 010101XX
            *([KS57dasm._dummy] * 8),                #11011101 01011XXX
            KS57dasm._jr_aea,                        #11011101 01100000
            KS57dasm._dummy,                         #11011101 01100001
            KS57dasm._incs_ahl,                      #11011101 01100010
            KS57dasm._dummy,                         #11011101 01100011
            KS57dasm._jr_awx,                        #11011101 01100100
            KS57dasm._dummy,                         #11011101 01100101
            KS57dasm._pop_sb,                        #11011101 01100110
            KS57dasm._push_sb,                       #11011101 01100111
            *([KS57dasm._cpse_a_r] * 8),             #11011101 01101RRR
            *([KS57dasm._cpse_ahl_im] * 16),         #11011101 0111DDDD
            *([KS57dasm._dummy] * 128),              #11011101 1XXXXXXX
        )
        
        self._instruction_11110101_tbl = (
            KS57dasm._band_cy_ahda_bit,              #11110101 00BBAAAA
            KS57dasm._band_cy_memb_al,               #11110101 0100AAAA
            KS57dasm._band_cy_mema_bit,              #11110101 10BBAAAA
            KS57dasm._band_cy_mema_bit               #11110101 11BBAAAA
        )
        
        self._instruction_11110110_tbl = (
            KS57dasm._bor_cy_ahda_bit,               #11110110 00BBAAAA
            KS57dasm._bor_cy_memb_al,                #11110110 0100AAAA
            KS57dasm._bor_cy_mema_bit,               #11110110 10BBAAAA
            KS57dasm._bor_cy_mema_bit                #11110110 11BBAAAA
        )

        self._instruction_11110111_tbl = (
            KS57dasm._bxor_cy_ahda_bit,              #11110111 00BBAAAA
            KS57dasm._bxor_cy_memb_al,               #11110111 0100AAAA
            KS57dasm._bxor_cy_mema_bit,              #11110111 10BBAAAA
            KS57dasm._bxor_cy_mema_bit               #11110111 11BBAAAA
        )
        
        self._instruction_11110100_tbl = (
            KS57dasm._ldb_cy_ahda_bit,               #11110100 00BBAAAA
            KS57dasm._ldb_cy_memb_al,                #11110100 0100AAAA
            KS57dasm._ldb_cy_mema_bit,               #11110100 10BBAAAA
            KS57dasm._ldb_cy_mema_bit                #11110100 11BBAAAA
        )
        
        self._instruction_11111000_tbl = (
            KS57dasm._btsf_ahda_bit,                 #11111000 00BBAAAA
            KS57dasm._btsf_memb_al,                  #11111000 0100AAAA
            KS57dasm._btsf_mema_bit,                 #11111000 10BBAAAA
            KS57dasm._btsf_mema_bit                  #11111000 11BBAAAA
        )

        self._instruction_11111001_tbl = (
            KS57dasm._btst_ahda_bit,                 #11111001 00BBAAAA
            KS57dasm._btst_memb_al,                  #11111001 0100AAAA
            KS57dasm._btst_mema_bit,                 #11111001 10BBAAAA
            KS57dasm._btst_mema_bit                  #11111001 11BBAAAA
        )
                
        self._instruction_11111100_tbl = (
            KS57dasm._ldb_ahda_bit_cy,               #11111100 00BBAAAA
            KS57dasm._ldb_memb_al_cy,                #11111100 0100AAAA
            KS57dasm._ldb_mema_bit_cy,               #11111100 10BBAAAA
            KS57dasm._ldb_mema_bit_cy                #11111100 11BBAAAA
        )
        
        self._instruction_11111110_tbl = (
            KS57dasm._bitr_ahda_bit,                 #11111110 00BBAAAA
            KS57dasm._bitr_memb_al,                  #11111110 0100AAAA
            KS57dasm._bitr_mema_bit,                 #11111110 10BBAAAA
            KS57dasm._bitr_mema_bit                  #11111110 11BBAAAA
        )
        
        self._instruction_11111111_tbl = (
            KS57dasm._bits_ahda_bit,                 #11111111 00BBAAAA
            KS57dasm._bits_memb_al,                  #11111111 0100AAAA
            KS57dasm._bits_mema_bit,                 #11111111 10BBAAAA
            KS57dasm._bits_mema_bit                  #11111111 11BBAAAA
        )

        self._instruction_11111101_tbl = (
            KS57dasm._btstz_ahda_bit,                #11111101 00BBAAAA
            KS57dasm._btstz_memb_al,                 #11111101 0100AAAA
            KS57dasm._btstz_mema_bit,                #11111101 10BBAAAA
            KS57dasm._btstz_mema_bit                 #11111101 11BBAAAA
        )
    ...
    def _disassemble(self, pc, listing, rom):
        while (pc > 0 and pc < len(listing) and listing[pc] is None):
            ...
            if (self._instruction_tbl[opcode] == KS57dasm._ref):
    ...
    def _disassemble_pcea(self, listing, rom):
        for i in range(rom.size()):
            opcode = rom.get_word(i)
            if (opcode == 0b1101110101100000):
                for j in range(i, (i & 0xFF00) + 0x100):
                    if (listing[j] is None):
                        listing = self._disassemble(j, listing, rom)
        return listing

    def _disassemble_ref(self, pc, ref_pc, listing, rom):
        opcode = rom.get_byte(ref_pc)
        if ((opcode & 0xC0) == 0x00):
            opcode = rom.get_word(ref_pc)
            a = opcode & 0x3FFF
            ...
            if (instruction_size == 2):
                listing[ref_pc] = (1, rom.get_byte(ref_pc), '')
    ...
    def _jr_raddr(self, pc, opcode, rom):
        #0001AAAA
        a = pc + 1 + (opcode & 0x0F)
        return (a, ), (1, opcode, "jr " + self._addrbase % a)

    def _jr_mraddr(self, pc, opcode, rom):
        #0000AAAA
        a = pc - (15 - (opcode & 0x0F))
        return (a,), (1, opcode, "jr " + self._addrbase % a)
    ...
    def _ads_a_im(self, pc, opcode, rom):
        #1010DDDD
        i = opcode & 0xF
        return (pc + 1, self._get_instr_skip_pc(pc + 1, rom)), (1, opcode, ("ads A, " + self._nibbase % i) if i else "nop")
    ...
    def _call_addr14(self, pc, opcode, rom):
        ...
        return (pc + 3, a, self._get_instr_skip_pc(pc + 3, rom)), (3, (opcode << 16) | a, "call " + self._addrbase % a)
    ...
    def _ads_ea_imm(self, pc, opcode, rom):
        #11001001 DDDDDDDD
        op = rom.get_byte(pc + 1)
        return (pc + 2, self._get_instr_skip_pc(pc + 2, rom)), (2, (opcode << 8) | op, "ads EA, " + self._bytebase % op)
    ...
    def _ads_rrb_ea(self, pc, opcode, rom):
        ...
        op = rom.get_byte(pc + 1)
        p = (op >> 1) & 0x3
        return (pc + 2, self._get_instr_skip_pc(pc + 2, rom)), (2, (opcode << 8) | op, "ads " + self._rpe_tbl[p] + ", EA")

    def _ads_ea_rr(self, pc, opcode, rom):
        #11011100 10011RR0
        op = rom.get_byte(pc + 1)
        p = (op >> 1) & 0x3
        return (pc + 2, self._get_instr_skip_pc(pc + 2, rom)), (2, (opcode << 8) | op, "ads EA, " + self._rpe_tbl[p])
