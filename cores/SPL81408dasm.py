...
class SPL81408dasm():
    def __init__(self):
        self._instructions = (
            (SPL81408dasm._brk, 1),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._rti, 1),
            *([(SPL81408dasm._dummy, 1)] * 2),
            (SPL81408dasm._ora_zp, 2),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._eor_zp, 2),
            (SPL81408dasm._bpl, 2),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._bvc, 2),
            (SPL81408dasm._dummy, 1),
            *([(SPL81408dasm._dummy, 1)] * 3),
            (SPL81408dasm._eor_zp_x, 2),
            (SPL81408dasm._jsr_abs, 3),
            (SPL81408dasm._bit_zp, 2),
            (SPL81408dasm._rts, 1),
            *([(SPL81408dasm._dummy, 1)] * 2),
            (SPL81408dasm._and_zp, 2),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._adc_zp, 2),
            (SPL81408dasm._bmi, 2),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._bvs, 2),
            *([(SPL81408dasm._dummy, 1)] * 9),
            (SPL81408dasm._sta_ind_x, 2),
            (SPL81408dasm._sta_zp, 2),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._cmp_zp, 2),
            (SPL81408dasm._bcc, 2),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._bne, 2),
            *([(SPL81408dasm._dummy, 1)] * 2),
            (SPL81408dasm._sta_zp_x, 2),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._cmp_zp_x, 2),
            *([(SPL81408dasm._dummy, 1)] * 2),
            (SPL81408dasm._cpx_imm, 2),
            (SPL81408dasm._cpx_zp, 2),
            (SPL81408dasm._lda_ind_x, 2),
            (SPL81408dasm._lda_zp, 2),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._sbc_zp, 2),
            (SPL81408dasm._bcs, 2),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._beq, 2),
            *([(SPL81408dasm._dummy, 1)] * 2),
            (SPL81408dasm._lda_zp_x, 2),
            *([(SPL81408dasm._dummy, 1)] * 2),
            (SPL81408dasm._php, 1),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._pha, 1),
            (SPL81408dasm._jmp_abs, 3),
            (SPL81408dasm._ora_imm, 2),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._eor_imm, 2),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._clc, 1),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._cli, 1),
            *([(SPL81408dasm._dummy, 1)] * 5),
            (SPL81408dasm._plp, 1),
            (SPL81408dasm._bit_abs, 3),
            (SPL81408dasm._pla, 1),
            (SPL81408dasm._jmp_ind, 3),
            (SPL81408dasm._and_imm, 2),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._adc_imm, 2),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._sec, 1),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._sei, 1),
            *([(SPL81408dasm._dummy, 1)] * 11),
            (SPL81408dasm._cmp_imm, 2),
            *([(SPL81408dasm._dummy, 1)] * 11),
            (SPL81408dasm._inx, 1),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._lda_imm, 2),
            (SPL81408dasm._lda_abs, 3),
            (SPL81408dasm._sbc_imm, 2),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._clv, 1),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._sed, 1),
            *([(SPL81408dasm._dummy, 1)] * 2),
            (SPL81408dasm._lda_abs_x, 3),
            *([(SPL81408dasm._dummy, 1)] * 19),                        
            (SPL81408dasm._rol_zp, 2),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._ror_zp, 2),
            *([(SPL81408dasm._dummy, 1)] * 13),   
            (SPL81408dasm._stx_zp, 2),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._dec_zp, 2),
            *([(SPL81408dasm._dummy, 1)] * 7),  
            (SPL81408dasm._dec_zp_x, 2),
            *([(SPL81408dasm._dummy, 1)] * 4), 
            (SPL81408dasm._ldx_imm, 2),
            (SPL81408dasm._ldx_zp, 2),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._inc_zp, 2),
            *([(SPL81408dasm._dummy, 1)] * 28),           
            (SPL81408dasm._rol_a, 1),
            (SPL81408dasm._dummy, 1),
            (SPL81408dasm._ror_a, 1),
            *([(SPL81408dasm._dummy, 1)] * 13),   
            (SPL81408dasm._txa, 1),
            (SPL81408dasm._stx_abs, 3),
            (SPL81408dasm._dex, 1),
            *([(SPL81408dasm._dummy, 1)] * 5),
            (SPL81408dasm._txs, 1),
            *([(SPL81408dasm._dummy, 1)] * 7),
            (SPL81408dasm._tax, 1),
            (SPL81408dasm._ldx_abs, 3),
            (SPL81408dasm._nop, 1),
            *([(SPL81408dasm._dummy, 1)] * 5),
            (SPL81408dasm._tsx, 1),
            *([(SPL81408dasm._dummy, 1)] * 7)
    ...
    def disassemble(self, rom):
        if (rom.size() > 0):
            ...
            listing = self._disassemble(0x200, listing, rom, 0, 0)
